...
type KDexHostSpec struct {
	...
	// +kubebuilder:validation:Optional
	FaviconSVGTemplate string `json:"faviconSVGTemplate,omitempty" protobuf:"bytes,7,opt,name=faviconSVGTemplate"`
	...
	ModulePolicy ModulePolicy `json:"modulePolicy" protobuf:"bytes,8,opt,name=modulePolicy,casttype=ModulePolicy"`

	// organization is the name of the Organization to which the host belongs.
	// +kubebuilder:validation:Required
	// +kubebuilder:validation:MinLength=5
	Organization string `json:"organization" protobuf:"bytes,9,req,name=organization"`

	// routing defines the desired routing configuration for the host.
	// +kubebuilder:validation:Required
	Routing Routing `json:"routing" protobuf:"bytes,10,req,name=routing"`
	...
	Security *[]SecurityRequirement `json:"security,omitempty" yaml:"security,omitempty" protobuf:"bytes,12,rep,name=security"`
	...
	ThemeRef *KDexObjectReference `json:"themeRef,omitempty" protobuf:"bytes,13,opt,name=themeRef"`
	...
	TranslationRefs []KDexObjectReference `json:"translationRefs,omitempty" protobuf:"bytes,14,rep,name=translationRefs"`

	// utilityPages defines the utility pages (announcement, error, login) for the host.
	// +kubebuilder:validation:Optional
	UtilityPages *UtilityPages `json:"utilityPages,omitempty" protobuf:"bytes,15,opt,name=utilityPages"`
}
