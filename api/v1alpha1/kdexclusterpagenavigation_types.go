...
// KDexClusterPageNavigationSpec defines the desired state of KDexClusterPageNavigation
type KDexClusterPageNavigationSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file
	// The following markers will use OpenAPI v3 schema to validate the value
	// More info: https://book.kubebuilder.io/reference/markers/crd-validation.html

	// foo is an example field of KDexClusterPageNavigation. Edit kdexclusterpagenavigation_types.go to remove/update
	// +optional
...
type KDexClusterPageNavigation struct {
	...
	// +required
	Spec KDexClusterPageNavigationSpec `json:"spec"`
