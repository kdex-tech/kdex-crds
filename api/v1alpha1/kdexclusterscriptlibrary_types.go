...
type KDexClusterScriptLibraryStatus struct {
	...
	// conditions represent the current state of the KDexClusterScriptLibrary resource.
...
type KDexClusterScriptLibrary struct {
	...
	// +optional
	Status KDexClusterScriptLibraryStatus `json:"status,omitzero"`
}

// +kubebuilder:object:root=true

// KDexClusterScriptLibraryList contains a list of KDexClusterScriptLibrary
type KDexClusterScriptLibraryList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitzero"`
	Items           []KDexClusterScriptLibrary `json:"items"`
}

func init() {
	SchemeBuilder.Register(&KDexClusterScriptLibrary{}, &KDexClusterScriptLibraryList{})
}
