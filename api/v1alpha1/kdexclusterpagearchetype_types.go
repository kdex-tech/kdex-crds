...
// KDexClusterPageArchetypeSpec defines the desired state of KDexClusterPageArchetype
type KDexClusterPageArchetypeSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file
	// The following markers will use OpenAPI v3 schema to validate the value
	// More info: https://book.kubebuilder.io/reference/markers/crd-validation.html

	// foo is an example field of KDexClusterPageArchetype. Edit kdexclusterpagearchetype_types.go to remove/update
	// +optional
...
type KDexClusterPageArchetype struct {
	...
	// +required
	Spec KDexClusterPageArchetypeSpec `json:"spec"`
