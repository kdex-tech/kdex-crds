...
type KDexInternalPageBindingSpec struct {
	...
	// foo is an example field of KDexInternalPageBinding. Edit kdexinternalpagebinding_types.go to remove/update
	// +optional
	Foo *string `json:"foo,omitempty"`
}

// KDexInternalPageBindingStatus defines the observed state of KDexInternalPageBinding.
type KDexInternalPageBindingStatus struct {
	...
	// conditions represent the current state of the KDexInternalPageBinding resource.
...
type KDexInternalPageBinding struct {
	...
	// status defines the observed state of KDexInternalPageBinding
	// +optional
	Status KDexInternalPageBindingStatus `json:"status,omitzero"`
}
